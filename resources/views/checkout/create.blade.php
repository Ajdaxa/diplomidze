...
@section('content')
    <div class="mx-auto max-w-2xl rounded-xl border border-stone-200 bg-white p-6">
        ...
        <form method="POST" action="{{ route('checkout.store') }}" class="space-y-4">
            ...
            <div>
                <label class="mb-1 block text-sm">Сумма (демо)</label>
                <input type="number" name="total_price" value="3990" class="w-full rounded-lg border border-stone-300 px-3 py-2">
            </div>
            <div>
